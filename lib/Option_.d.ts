...
export declare const map: <A, B>(fa: Option<A>, f: (a: A) => B) => Option<B>;
export declare const of: <A>(a: A) => Option<A>;
export declare const ap: <A, B>(fab: Option<(a: A) => B>, fa: Option<A>) => Option<B>;
export declare const chain: <A, B>(fa: Option<A>, f: (a: A) => Option<B>) => Option<B>;
export declare const reduce: <A, B>(fa: Option<A>, b: B, f: (b: B, a: A) => B) => B;
export declare const foldMap: <M>(M: Monoid<M>) => <A>(fa: Option<A>, f: (a: A) => M) => M;
export declare const foldr: <A, B>(fa: Option<A>, b: B, f: (a: A, b: B) => B) => B;
export declare const traverse: <F>(F: Applicative<F>) => <A, B>(ta: Option<A>, f: (a: A) => HKT<F, B>) => HKT<F, Option<B>>;
export declare const sequence: <F>(F: Applicative<F>) => <A>(ta: Option<HKT<F, A>>) => HKT<F, Option<A>>;
export declare const alt: <A>(fx: Option<A>, fy: Option<A>) => Option<A>;
export declare const extend: <A, B>(ea: Option<A>, f: (ea: Option<A>) => B) => Option<B>;
...
export declare const filter: <A>(fa: Option<A>, p: Predicate<A>) => Option<A>;
export declare const filterMap: <A, B>(fa: Option<A>, f: (a: A) => Option<B>) => Option<B>;
export declare const wither: <F>(F: Applicative<F>) => <A, B>(fa: Option<A>, f: (a: A) => HKT<F, Option<B>>) => HKT<F, Option<B>>;
