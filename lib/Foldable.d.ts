 ...
 * @since 1.10.0
 */
export declare function fold<M, F extends URIS3>(M: Monoid<M>, F: Foldable3<F>): <U, L>(fa: Type3<F, U, L, M>) => M;
export declare function fold<M, F extends URIS3, U, L>(M: Monoid<M>, F: Foldable3C<F, U, L>): (fa: Type3<F, U, L, M>) => M;
export declare function fold<M, F extends URIS2>(M: Monoid<M>, F: Foldable2<F>): <L>(fa: Type2<F, L, M>) => M;
export declare function fold<M, F extends URIS2, L>(M: Monoid<M>, F: Foldable2C<F, L>): (fa: Type2<F, L, M>) => M;
export declare function fold<M, F extends URIS>(M: Monoid<M>, F: Foldable1<F>): (fa: Type<F, M>) => M;
export declare function fold<M, F>(M: Monoid<M>, F: Foldable<F>): (fa: HKT<F, M>) => M;
/**
 ...
 * @since 1.10.0
 */
export declare function oneOf<P extends URIS3, F extends URIS>(P: Plus3<P>, F: Foldable1<F>): <U, L, A>(fga: Type<F, Type3<P, U, L, A>>) => Type3<P, U, L, A>;
export declare function oneOf<P extends URIS3, U, L, F extends URIS>(P: Plus3C<P, U, L>, F: Foldable1<F>): <A>(fga: Type<F, Type3<P, U, L, A>>) => Type3<P, U, L, A>;
export declare function oneOf<P extends URIS2, F extends URIS>(P: Plus2<P>, F: Foldable1<F>): <L, A>(fga: Type<F, Type2<P, L, A>>) => Type2<P, L, A>;
export declare function oneOf<P extends URIS2, F extends URIS, L>(P: Plus2C<P, L>, F: Foldable1<F>): <A>(fga: Type<F, Type2<P, L, A>>) => Type2<P, L, A>;
export declare function oneOf<P extends URIS, F extends URIS>(P: Plus1<P>, F: Foldable1<F>): <A>(fga: Type<F, Type<P, A>>) => Type<P, A>;
export declare function oneOf<P, F>(P: Plus<P>, F: Foldable<F>): <A>(fga: HKT<F, HKT<P, A>>) => HKT<P, A>;
/**
 ...
 * @since 1.10.0
 */
export declare function sum<F extends URIS3, A>(S: Semiring<A>, F: Foldable3<F>): <U, L>(fa: Type3<F, U, L, A>) => A;
export declare function sum<F extends URIS3, A, U, L>(S: Semiring<A>, F: Foldable3C<F, U, L>): (fa: Type3<F, U, L, A>) => A;
export declare function sum<F extends URIS2, A>(S: Semiring<A>, F: Foldable2<F>): <L>(fa: Type2<F, L, A>) => A;
export declare function sum<F extends URIS2, A, L>(S: Semiring<A>, F: Foldable2C<F, L>): (fa: Type2<F, L, A>) => A;
export declare function sum<F extends URIS, A>(S: Semiring<A>, F: Foldable1<F>): (fa: Type<F, A>) => A;
export declare function sum<F, A>(S: Semiring<A>, F: Foldable<F>): (fa: HKT<F, A>) => A;
/**
 ...
 * @since 1.10.0
 */
export declare function product<F extends URIS3, A>(S: Semiring<A>, F: Foldable3<F>): <U, L>(fa: Type3<F, U, L, A>) => A;
export declare function product<F extends URIS3, A, U, L>(S: Semiring<A>, F: Foldable3C<F, U, L>): (fa: Type3<F, U, L, A>) => A;
export declare function product<F extends URIS2, A>(S: Semiring<A>, F: Foldable2<F>): <L>(fa: Type2<F, L, A>) => A;
export declare function product<F extends URIS2, A, L>(S: Semiring<A>, F: Foldable2C<F, L>): (fa: Type2<F, L, A>) => A;
export declare function product<F extends URIS, A>(S: Semiring<A>, F: Foldable1<F>): (fa: Type<F, A>) => A;
export declare function product<F, A>(S: Semiring<A>, F: Foldable<F>): (fa: HKT<F, A>) => A;
/**
 ...
 * @since 1.14.0
 */
export declare function elem<F extends URIS3, A>(S: Setoid<A>, F: Foldable3<F>): <U, L>(a: A, fa: Type3<F, U, L, A>) => boolean;
export declare function elem<F extends URIS3, A, U, L>(S: Setoid<A>, F: Foldable3C<F, U, L>): (a: A, fa: Type3<F, U, L, A>) => boolean;
export declare function elem<F extends URIS2, A>(S: Setoid<A>, F: Foldable2<F>): <L>(a: A, fa: Type2<F, L, A>) => boolean;
export declare function elem<F extends URIS2, A, L>(S: Setoid<A>, F: Foldable2C<F, L>): (a: A, fa: Type2<F, L, A>) => boolean;
export declare function elem<F extends URIS, A>(S: Setoid<A>, F: Foldable1<F>): (a: A, fa: Type<F, A>) => boolean;
export declare function elem<F, A>(S: Setoid<A>, F: Foldable<F>): (a: A, fa: HKT<F, A>) => boolean;
/**
 ...
 * @since 1.10.0
 */
export declare function findFirst<F extends URIS3>(F: Foldable3<F>): <U, L, A>(fa: Type3<F, U, L, A>, p: Predicate<A>) => Option<A>;
export declare function findFirst<F extends URIS3, U, L>(F: Foldable3C<F, U, L>): <A>(fa: Type3<F, U, L, A>, p: Predicate<A>) => Option<A>;
export declare function findFirst<F extends URIS2>(F: Foldable2<F>): <L, A>(fa: Type2<F, L, A>, p: Predicate<A>) => Option<A>;
export declare function findFirst<F extends URIS2, L>(F: Foldable2C<F, L>): <A>(fa: Type2<F, L, A>, p: Predicate<A>) => Option<A>;
export declare function findFirst<F extends URIS>(F: Foldable1<F>): <A>(fa: Type<F, A>, p: Predicate<A>) => Option<A>;
export declare function findFirst<F>(F: Foldable<F>): <A>(fa: HKT<F, A>, p: Predicate<A>) => Option<A>;
/**
 ...
 * @since 1.10.0
 */
export declare function min<F extends URIS3, A>(O: Ord<A>, F: Foldable3<F>): <U, L>(fa: Type3<F, U, L, A>) => Option<A>;
export declare function min<F extends URIS3, A, U, L>(O: Ord<A>, F: Foldable3C<F, U, L>): (fa: Type3<F, U, L, A>) => Option<A>;
export declare function min<F extends URIS2, A>(O: Ord<A>, F: Foldable2<F>): <L>(fa: Type2<F, L, A>) => Option<A>;
export declare function min<F extends URIS2, A, L>(O: Ord<A>, F: Foldable2C<F, L>): (fa: Type2<F, L, A>) => Option<A>;
export declare function min<F extends URIS, A>(O: Ord<A>, F: Foldable1<F>): (fa: Type<F, A>) => Option<A>;
export declare function min<F, A>(O: Ord<A>, F: Foldable<F>): (fa: HKT<F, A>) => Option<A>;
/**
 ...
 * @since 1.10.0
 */
export declare function max<F extends URIS3, A>(O: Ord<A>, F: Foldable3<F>): <U, L>(fa: Type3<F, U, L, A>) => Option<A>;
export declare function max<F extends URIS3, A, U, L>(O: Ord<A>, F: Foldable3C<F, U, L>): (fa: Type3<F, U, L, A>) => Option<A>;
export declare function max<F extends URIS2, A>(O: Ord<A>, F: Foldable2<F>): <L>(fa: Type2<F, L, A>) => Option<A>;
export declare function max<F extends URIS2, A, L>(O: Ord<A>, F: Foldable2C<F, L>): (fa: Type2<F, L, A>) => Option<A>;
export declare function max<F extends URIS, A>(O: Ord<A>, F: Foldable1<F>): (fa: Type<F, A>) => Option<A>;
export declare function max<F, A>(O: Ord<A>, F: Foldable<F>): (fa: HKT<F, A>) => Option<A>;
/**
