 ...
 * @since 1.14.0
 */
export declare function elem<F extends URIS3, A>(S: Setoid<A>, F: Foldable2v3<F>): <U, L>(a: A, fa: Type3<F, U, L, A>) => boolean;
export declare function elem<F extends URIS3, A, U, L>(S: Setoid<A>, F: Foldable2v3C<F, U, L>): (a: A, fa: Type3<F, U, L, A>) => boolean;
export declare function elem<F extends URIS2, A>(S: Setoid<A>, F: Foldable2v2<F>): <L>(a: A, fa: Type2<F, L, A>) => boolean;
export declare function elem<F extends URIS2, A, L>(S: Setoid<A>, F: Foldable2v2C<F, L>): (a: A, fa: Type2<F, L, A>) => boolean;
export declare function elem<F extends URIS, A>(S: Setoid<A>, F: Foldable2v1<F>): (a: A, fa: Type<F, A>) => boolean;
export declare function elem<F, A>(S: Setoid<A>, F: Foldable2v<F>): (a: A, fa: HKT<F, A>) => boolean;
/**
