 ...
 * @since 1.14.0
 */
export declare function fromFoldable<K, F extends URIS3>(S: Setoid<K>, F: Foldable3<F>): <U, L, A>(ta: Type3<F, U, L, [K, A]>, onConflict: (existing: A, a: A) => A) => Map<K, A>;
export declare function fromFoldable<K, F extends URIS2>(S: Setoid<K>, F: Foldable2<F>): <L, A>(ta: Type2<F, L, [K, A]>, onConflict: (existing: A, a: A) => A) => Map<K, A>;
export declare function fromFoldable<K, F extends URIS>(S: Setoid<K>, F: Foldable1<F>): <A>(ta: Type<F, [K, A]>, onConflict: (existing: A, a: A) => A) => Map<K, A>;
export declare function fromFoldable<K, F>(S: Setoid<K>, F: Foldable<F>): <A>(ta: HKT<F, [K, A]>, onConflict: (existing: A, a: A) => A) => Map<K, A>;
/**
 * @since 1.14.0
 */
