...
exports.compact = function (fa) { return fa.chain(function_1.identity); };
exports.filter = function (fa, p) { return fa.filter(p); };
exports.filterMap = exports.chain;
exports.wither = function (F) { return function (fa, f) { return (fa.isNone() ? F.of(fa) : f(fa.value)); }; };
